...
export interface Bindings {
  DATABASE_URL: string; AUTH_SECRET: string; AUTH_URL: string; APP_URL: string; ALLOWED_ORIGINS: string; TURNSTILE_SECRET?: string; RESEND_API_KEY?: string; EMAIL_FROM?: string; R2_BUCKET: R2Bucket;
}
